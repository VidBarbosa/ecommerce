...
function trd_assets(){
    ...
    wp_enqueue_script("trdagency-js",get_template_directory_uri()."/assets/js/script.js");
}

add_action("wp_enqueue_scripts","trd_assets");

function trd_analytics(){
    ?>
    
    <?php
}

add_action("wp_body_open","trd_analytics");

function trd_theme_supports(){
...
add_action("after_setup_theme","trd_theme_supports");

function trd_add_menus(){
    register_nav_menus(
        array(
...
add_action("after_setup_theme", "trd_add_menus");

function trd_add_sidebar(){
    register_sidebar(
        array(
            'name' => 'Pie de página',
            'id' => 'pie-pagina',
...
add_action("widgets_init","trd_add_sidebar");

function trd_add_custom_post_type(){
...
add_action("init","trd_add_custom_post_type");

function trd_add_to_signin_menu(){
...
add_action("trd_signin","trd_add_to_signin_menu");